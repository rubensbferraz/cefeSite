                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <Nav className="barraMenu ">
                        <NavDropdown eventKey={1} title="Casa Espírita" id="basic-nav-dropdown">
                            ...
                            <NavDropdown eventKey={2} title="Administração:" id="administracao">
                        ...
                        <NavDropdown eventKey={4} title="Prática" id="basic2">
                            ...
                            <NavDropdown eventKey={6} title="Atendimento:" id="atendimento">
                        ...
                        <NavDropdown eventKey={7} title="Arte" id="arte">
                            {/*<!-- Quarto botão Arte -->*/}
                            <NavDropdown eventKey={8} title="Corais:" id="basic5">
                        ...
                        <NavDropdown eventKey={9} title="Contato" id="basic6" >
                            {/*<!-- Quinto botão Contato -->*/}
                            <NavDropdown eventKey={10} title="Redes Sociais:" id="redesociais">
